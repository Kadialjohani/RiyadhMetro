...
const Footer: React.FC<FooterProps> = ({ isLoggedIn }) => {
  return (
    <div className="bg-[#053B50] w-full lg:h-40  md:h-[60px] h-[60px] flex justify-center">
      <ul className="flex flex-row lg:justify-between justify-center lg:items-center items-center lg:w-full lg:mx-24 font-bold lg:text-lg text-[#EEEEEE]">
        {!isLoggedIn && (
          <>
        ...
        {isLoggedIn && (
          <>
            <div className="flex flex-row lg:items-center gap-2 lg:justify-between items-center j lg:text-6xl lg:w-1/6 ">
              <li>
                <a href="https://www.instagram.com/riyadhtransport/">
                  <FontAwesomeIcon icon={faSquareInstagram} />
                </a>
