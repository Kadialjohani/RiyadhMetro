  ...
  return (
    <div>
      <div className="relative lg:h-[88vh] md:h-[44vh] h-[37vh] w-full">
        ...
        <img
          className="z-0 h-[38vh] md:h-[45vh] absolute lg:hidden"
          src={bgimg}
        ></img>
        ...
        <div className="z-20 h-32 w-[70%] md:h-48 md:w-3/5 lg:h-80 lg:w-3/5 p-3 lg:top-96 top-40 flex flex-col justify-center items-center border-2 border-[#EEEEEE] rounded-3xl md:top-72 left-1/2 transform -translate-x-1/2 -translate-y-1/2 absolute">
          ...
          <a href="/login">
            <button className="rounded-3xl lg:w-72 lg:h-16 w-28 md:w-40 md:h-12 h-10 font-bold md:text-xl lg:text-2xl text-sm bg-[#64CCC5] text-[#053B50] ">
              Book Now
            </button>
          </a>
        </div>
      ...
      >
        <h1 className="font-bold text-lg lg:text-5xl md:text-2xl lg:mb-20 md:mb-10 lg:w-full m-6 md:mt-14 text-center text-[#EEEEEE] ">
      ...
      <div
        id="about"
        className="flex flex-col justify-center items-center bg-[#053B50]  w-full h-80"
      >
        <h1 className="font-bold text-4xl mb-5 text-[#EEEEEE]">About</h1>
        <h1 className=" lg:leading-loose md:leading-loose leading-8 lg:text-xl md:text-sm text-sm text-[#EEEEEE] lg:w-3/5 md:w-4/5 w-4/5 text-center">
